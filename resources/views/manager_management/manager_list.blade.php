			...
			<div class="modal-content">
                ...
                <h1 class="title">담당자 관리</h1>
                    <form name="form1" action="create_customer_process.php" method="post">
                        ...
                        <label for="in">담당자명</label> <input class="registerSearch" id="in" type="text" name="manager" value=""/><br>
                        <label for="in1">거래처</label><input class="registerSearch" id="in1" type="text" name="customer" value=""/><br>
                        <label for="in2">연락처</label><input class="registerSearch" id="in2" type="tel" name="phone" value=""/><br>
                        <label for="in3">이메일</label><input class="registerSearch" id="in3" type="text" name="email" value=""/>
                    </div>
