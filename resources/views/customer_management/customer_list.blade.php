			...
			<div class="modal-content">
                ...
                <h1 class="title">거래처 관리</h1>
                    <form name="form1" action="create_customer_process.php" method="post">
                        ...
                        <label for="in">거래처명</label> <input id="in" type="text" name="customer_name" value=""/><br>
                        <label for="in1">사업자번호</label><input id="in1" type="text" name="business_id" value=""/><br>
                        <label for="in2">전화번호</label><input id="in2" type="text" name="phone" value=""/><br>
                        <label for="in3">주소</label> <input id="in3" type="text" name="address" value=""/><br>
                        <label for="in4">대표자</label><input id="in4" type="text" name="ceo" value=""/><br>
                        <label for="in5">비고</label><input id="in5" type="text" name="note" value=""/>
                    </div>
