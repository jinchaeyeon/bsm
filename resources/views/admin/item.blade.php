...
<div class="min-h-screen" style="margin-left: 5%; margin-right: 5%;width: 77%;float:right">
    ...
    <div style="margin-top: 10px;">
        <label><input type="radio" name="chk_info" value="품목코드"
                      onclick="javascript:checkRadio()">품목코드</label><label><input
                type="radio" name="chk_info" value="품목명"
                onclick="javascript:checkRadio()">품목명</label> <label><input
                type="radio" name="chk_info" value="비고"
